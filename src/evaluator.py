# Source https://github.com/UKPLab/sentence-transformers/blob/master/sentence_transformers/evaluation/InformationRetrievalEvaluator.py
...
class InformationRetrievalEvaluator(SentenceEvaluator):
    ...
    def compute_metrices(self, corpus_embeddings: Tensor, query_embeddings: Tensor) -> Dict[str, float]:
        max_k = max(
            max(self.mrr_at_k),
            max(self.ndcg_at_k),
